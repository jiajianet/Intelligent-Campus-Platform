...
public class OffcialSiteController extends BaseController {
    ...
    public Object index() {
        ...
        List<cn.xiyanchenghong.waimai.bean.entity.cms.Article> articles = articleService.queryIndexNews();
        for (cn.xiyanchenghong.waimai.bean.entity.cms.Article article : articles) {
            News news = new News();
