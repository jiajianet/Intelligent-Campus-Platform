...
CREATE TABLE `t_cms_article`  (
  ...
  `img` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '文章题图ID',
  `title` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '标题',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文章' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_cms_article
-- ----------------------------
INSERT INTO `t_cms_article` VALUES (4, 1, '2024-10-09 16:24:58', 1, '2024-04-28 00:34:21', 'xiyanchenghong.cn', 'H5通用官网系统', 2, '17', 'H5通用官网系统');
INSERT INTO `t_cms_article` VALUES (5, 1, '2024-10-09 16:24:58', 1, '2024-04-28 00:34:36', 'xiyanchenghong.cn', 'H5通用论坛系统', 2, '18', 'H5通用论坛系统');
INSERT INTO `t_cms_article` VALUES (6, 1, '2024-10-09 16:24:58', 1, '2024-04-28 00:38:33', 'xiyanchenghong.cn', '官网建设方案', 3, '19', '官网建设方案');
INSERT INTO `t_cms_article` VALUES (7, 1, '2024-10-09 16:24:58', 1, '2024-04-28 00:39:48', 'xiyanchenghong.cn', '论坛建设方案', 3, '22', '论坛建设方案');
INSERT INTO `t_cms_article` VALUES (8, 1, '2024-10-09 16:24:58', 1, '2024-04-28 17:39:52', 'xiyanchenghong.cn', '案例1', 4, '3', '案例1');
INSERT INTO `t_cms_article` VALUES (9, 1, '2024-10-09 16:24:58', 1, '2024-04-28 00:39:11', 'xiyanchenghong.cn', '案例2', 4, '20', '案例2');
...
CREATE TABLE `t_cms_banner`  (
  ...
  `url` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '点击banner跳转到url',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文章' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_cms_banner
-- ----------------------------
INSERT INTO `t_cms_banner` VALUES (1, 1, '2024-03-09 16:29:03', NULL, NULL, 1, '不打开链接', 'index', 'javascript:');
INSERT INTO `t_cms_banner` VALUES (2, 1, '2024-03-09 16:29:03', NULL, NULL, 2, '打打开站内链接', 'index', '/contact');
INSERT INTO `t_cms_banner` VALUES (3, 1, '2024-03-09 16:29:03', NULL, NULL, 6, '打开外部链接', 'index', 'http://www.baidu.com');
INSERT INTO `t_cms_banner` VALUES (4, 1, '2024-03-09 16:29:03', NULL, NULL, 1, '不打开链接', 'product', 'javascript:');
INSERT INTO `t_cms_banner` VALUES (5, 1, '2024-03-09 16:29:03', NULL, NULL, 2, '打打开站内链接', 'product', '/contact');
INSERT INTO `t_cms_banner` VALUES (6, 1, '2024-03-09 16:29:03', NULL, NULL, 6, '打开外部链接', 'product', 'http://www.baidu.com');
INSERT INTO `t_cms_banner` VALUES (7, 1, '2024-03-09 16:29:03', NULL, NULL, 1, '不打开链接', 'solution', 'javascript:');
INSERT INTO `t_cms_banner` VALUES (8, 1, '2024-03-09 16:29:03', NULL, NULL, 2, '打打开站内链接', 'solution', '/contact');
INSERT INTO `t_cms_banner` VALUES (9, 1, '2024-03-09 16:29:03', NULL, NULL, 6, '打开外部链接', 'solution', 'http://www.baidu.com');
INSERT INTO `t_cms_banner` VALUES (10, 1, '2024-03-09 16:29:03', NULL, NULL, 1, '不打开链接', 'case', 'javascript:');
INSERT INTO `t_cms_banner` VALUES (11, 1, '2024-03-09 16:29:03', NULL, NULL, 2, '打打开站内链接', 'case', '/contact');
INSERT INTO `t_cms_banner` VALUES (12, 1, '2024-03-09 16:29:03', NULL, NULL, 6, '打开外部链接', 'case', 'http://www.baidu.com');
INSERT INTO `t_cms_banner` VALUES (14, 1, '2024-03-09 16:29:03', NULL, NULL, 1, '不打开链接', 'news', 'javascript:');
INSERT INTO `t_cms_banner` VALUES (15, 1, '2024-03-09 16:29:03', NULL, NULL, 2, '打打开站内链接', 'news', '/contact');
INSERT INTO `t_cms_banner` VALUES (16, 1, '2024-03-09 16:29:03', NULL, NULL, 6, '打开外部链接', 'news', 'http://www.baidu.com');
...
CREATE TABLE `t_cms_channel`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文章栏目' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_cms_channel
-- ----------------------------
INSERT INTO `t_cms_channel` VALUES (1, NULL, NULL, 1, '2024-03-13 22:52:46', 'news', '动态资讯');
INSERT INTO `t_cms_channel` VALUES (2, NULL, NULL, 1, '2024-03-13 22:53:11', 'product', '产品服务');
INSERT INTO `t_cms_channel` VALUES (3, NULL, NULL, 1, '2024-03-13 22:53:37', 'solution', '解决方案');
INSERT INTO `t_cms_channel` VALUES (4, NULL, NULL, 1, '2024-03-13 22:53:41', 'case', '精选案例');
...
CREATE TABLE `t_cms_contacts`  (
  ...
  `mobile` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '联系电话',
  `remark` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `user_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '邀约人名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '邀约信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_cms_contacts
-- ----------------------------
INSERT INTO `t_cms_contacts` VALUES (1, NULL, '2024-10-31 17:44:27', NULL, '2024-10-31 17:44:27', '1074711419@qq.com', '18128732222', '测试联系，哈哈哈', '小王');
...
CREATE TABLE `t_message`  (
  ...
  `receiver` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '接收者',
  `state` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '消息类型,0:初始,1:成功,2:失败',
  `tpl_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '模板编码',
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '消息类型,0:短信,1:邮件',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '历史消息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_message
-- ----------------------------
INSERT INTO `t_message` VALUES (1, NULL, '2024-10-10 21:20:16', NULL, NULL, '校验码1032，请于10分钟内完成验证，如非本人操作请忽略本短信。', '15021592814', '2', 'REGISTER_CODE', '0');
...
CREATE TABLE `t_message_sender`  (
  ...
  `modify_by` bigint(0) NULL DEFAULT NULL COMMENT '最后更新人',
  `modify_time` datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  `class_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '发送类',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '名称',
  `tpl_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '短信运营商模板编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '消息发送者' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_message_template`  (
  ...
  `cond` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '发送条件',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '内容',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '消息模板' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_sys_cfg`  (
  ...
  `modify_by` bigint(0) NULL DEFAULT NULL COMMENT '最后更新人',
  `modify_time` datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  `cfg_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '备注',
  `cfg_name` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '参数名',
  `cfg_value` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '参数值',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统参数' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_sys_cfg
-- ----------------------------
INSERT INTO `t_sys_cfg` VALUES (1, NULL, NULL, -1, '2024-05-14 17:00:00', 'update by 2024-05-14 17:00:00', 'system.app.name', 'flash-waimai');
INSERT INTO `t_sys_cfg` VALUES (2, NULL, NULL, 1, '2024-04-15 21:36:17', '系统默认上传文件路径', 'system.file.upload.path', 'E:/data/flash-waimai/runtime/upload');
INSERT INTO `t_sys_cfg` VALUES (3, NULL, NULL, 1, '2024-04-15 21:36:17', '腾讯sms接口appid', 'api.tencent.sms.appid', '1400219425');
INSERT INTO `t_sys_cfg` VALUES (4, NULL, NULL, 1, '2024-04-15 21:36:17', '腾讯sms接口appkey', 'api.tencent.sms.appkey', '5f71ed5325f3b292946530a1773e997a');
INSERT INTO `t_sys_cfg` VALUES (5, NULL, NULL, 1, '2024-04-15 21:36:17', '腾讯sms接口签名参数', 'api.tencent.sms.sign', '1400219425');
INSERT INTO `t_sys_cfg` VALUES (6, NULL, NULL, 1, '2024-05-14 16:59:49', '平台盈利额', 'system.platform.total.amount', '-5.80');
INSERT INTO `t_sys_cfg` VALUES (7, NULL, NULL, 1, '2024-05-13 22:59:20', '小程序appid', 'api.tencent.mini.program.appid', 'wx234234234234234');
INSERT INTO `t_sys_cfg` VALUES (8, NULL, NULL, 1, '2024-05-13 22:59:20', '小程序appsecret', 'api.tencent.mini.program.secret', '234234234234');
...
CREATE TABLE `t_sys_dept`  (
  ...
  `pids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `simplename` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `tips` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `version` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '部门' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_sys_dict`  (
  ...
  `tips` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 71 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_sys_dict` VALUES (68, 1, '2024-01-13 14:18:21', 1, '2024-01-13 14:18:21', '是否', '0', 0, NULL);
INSERT INTO `t_sys_dict` VALUES (69, 1, '2024-01-13 14:18:21', 1, '2024-01-13 14:18:21', '是', '1', 68, NULL);
INSERT INTO `t_sys_dict` VALUES (70, 1, '2024-01-13 14:18:21', 1, '2024-01-13 14:18:21', '否', '0', 68, NULL);
...
CREATE TABLE `t_sys_file_info`  (
  ...
  `real_file_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1899 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文件' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_sys_login_log`  (
  ...
  `succeed` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userid` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '登录日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_sys_login_log
-- ----------------------------
INSERT INTO `t_sys_login_log` VALUES (71, '2024-10-10 13:17:43', '127.0.0.1', '登录日志', NULL, '成功', 1);
INSERT INTO `t_sys_login_log` VALUES (72, '2024-10-12 13:36:56', '127.0.0.1', '登录日志', NULL, '成功', 1);
...
CREATE TABLE `t_sys_menu`  (
  ...
  `ismenu` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '是否是菜单1:菜单,0:按钮',
  `isopen` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '是否默认打开1:是,0:否',
  `levels` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '级别',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '名称',
  `num` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '顺序',
  `pcode` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '父菜单编号',
  `pcodes` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '递归父级菜单编号',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '状态1:启用,0:禁用',
  `tips` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '鼠标悬停提示信息',
  `url` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '链接',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UK_s37unj3gh67ujhk83lqva8i1t`(`code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 84 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_sys_menu
-- ----------------------------
INSERT INTO `t_sys_menu` VALUES (1, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'system', 'fa-cog', '1', '1', '1', '系统管理', '4', '0', '[0],', '1', NULL, '/system');
INSERT INTO `t_sys_menu` VALUES (2, 1, '2024-07-31 22:04:30', 1, '2024-03-11 22:25:38', 'cms', NULL, '1', NULL, '1', 'CMS管理', '5', '0', '[0],', '1', NULL, '/cms');
INSERT INTO `t_sys_menu` VALUES (3, 1, '2024-07-31 22:04:30', 1, '2024-06-02 10:09:09', 'operationMgr', NULL, '1', NULL, '1', '运维管理', '3', '0', '[0],', '1', NULL, '/optionMgr');
INSERT INTO `t_sys_menu` VALUES (4, 1, '2024-07-31 22:04:30', 1, '2024-04-16 18:59:15', 'mgr', NULL, '1', NULL, '2', '用户管理', '1', 'system', '[0],[system],', '1', NULL, '/mgr');
INSERT INTO `t_sys_menu` VALUES (5, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'mgr.add', NULL, '0', NULL, '3', '添加用户', '1', 'mgr', '[0],[system],[mgr],', '1', NULL, '/mgr/add');
INSERT INTO `t_sys_menu` VALUES (6, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'mgr.edit', NULL, '0', NULL, '3', '修改用户', '2', 'mgr', '[0],[system],[mgr],', '1', NULL, '/mgr/edit');
INSERT INTO `t_sys_menu` VALUES (7, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'mgr.delete', NULL, '0', '0', '3', '删除用户', '3', 'mgr', '[0],[system],[mgr],', '1', NULL, '/mgr/delete');
INSERT INTO `t_sys_menu` VALUES (8, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'mgr.reset', NULL, '0', '0', '3', '重置密码', '4', 'mgr', '[0],[system],[mgr],', '1', NULL, '/mgr/reset');
INSERT INTO `t_sys_menu` VALUES (9, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'mgr.freeze', NULL, '0', '0', '3', '冻结用户', '5', 'mgr', '[0],[system],[mgr],', '1', NULL, '/mgr/freeze');
INSERT INTO `t_sys_menu` VALUES (10, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'mgr.unfreeze', NULL, '0', '0', '3', '解除冻结用户', '6', 'mgr', '[0],[system],[mgr],', '1', NULL, '/mgr/unfreeze');
INSERT INTO `t_sys_menu` VALUES (11, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'mgr.set.role', NULL, '0', '0', '3', '分配角色', '7', 'mgr', '[0],[system],[mgr],', '1', NULL, '/mgr/setRole');
INSERT INTO `t_sys_menu` VALUES (12, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'role', NULL, '1', '0', '2', '角色管理', '2', 'system', '[0],[system],', '1', NULL, '/role');
INSERT INTO `t_sys_menu` VALUES (13, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'role.add', NULL, '0', '0', '3', '添加角色', '1', 'role', '[0],[system],[role],', '1', NULL, '/role/add');
INSERT INTO `t_sys_menu` VALUES (14, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'role.edit', NULL, '0', '0', '3', '修改角色', '2', 'role', '[0],[system],[role],', '1', NULL, '/role/edit');
INSERT INTO `t_sys_menu` VALUES (15, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'role.delete', NULL, '0', '0', '3', '删除角色', '3', 'role', '[0],[system],[role],', '1', NULL, '/role/remove');
INSERT INTO `t_sys_menu` VALUES (16, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'role.set.authority', NULL, '0', '0', '3', '配置权限', '4', 'role', '[0],[system],[role],', '1', NULL, '/role/setAuthority');
INSERT INTO `t_sys_menu` VALUES (17, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'menu', NULL, '1', '0', '2', '菜单管理', '4', 'system', '[0],[system],', '1', NULL, '/menu');
INSERT INTO `t_sys_menu` VALUES (18, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'menu.add', NULL, '0', '0', '3', '添加菜单', '1', 'menu', '[0],[system],[menu],', '1', NULL, '/menu/add');
INSERT INTO `t_sys_menu` VALUES (19, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'menu.edit', NULL, '0', '0', '3', '修改菜单', '2', 'menu', '[0],[system],[menu],', '1', NULL, '/menu/edit');
INSERT INTO `t_sys_menu` VALUES (20, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'menu.delete', NULL, '0', '0', '3', '删除菜单', '3', 'menu', '[0],[system],[menu],', '1', NULL, '/menu/remove');
INSERT INTO `t_sys_menu` VALUES (21, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dept', NULL, '1', NULL, '2', '部门管理', '3', 'system', '[0],[system],', '1', NULL, '/dept');
INSERT INTO `t_sys_menu` VALUES (22, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dict', NULL, '1', NULL, '2', '字典管理', '4', 'system', '[0],[system],', '1', NULL, '/dict');
INSERT INTO `t_sys_menu` VALUES (23, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dept.edit', NULL, '0', NULL, '3', '修改部门', '1', 'dept', '[0],[system],[dept],', '1', NULL, '/dept/update');
INSERT INTO `t_sys_menu` VALUES (24, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dept.delete', NULL, '0', NULL, '3', '删除部门', '1', 'dept', '[0],[system],[dept],', '1', NULL, '/dept/delete');
INSERT INTO `t_sys_menu` VALUES (25, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dict.add', NULL, '0', NULL, '3', '添加字典', '1', 'dict', '[0],[system],[dict],', '1', NULL, '/dict/add');
INSERT INTO `t_sys_menu` VALUES (26, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dict.edit', NULL, '0', NULL, '3', '修改字典', '1', 'dict', '[0],[system],[dict],', '1', NULL, '/dict/update');
INSERT INTO `t_sys_menu` VALUES (27, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dict.delete', NULL, '0', NULL, '3', '删除字典', '1', 'dict', '[0],[system],[dict],', '1', NULL, '/dict/delete');
INSERT INTO `t_sys_menu` VALUES (28, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dept.list', NULL, '0', NULL, '3', '部门列表', '5', 'dept', '[0],[system],[dept],', '1', NULL, '/dept/list');
INSERT INTO `t_sys_menu` VALUES (29, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dept.detail', NULL, '0', NULL, '3', '部门详情', '6', 'dept', '[0],[system],[dept],', '1', NULL, '/dept/detail');
INSERT INTO `t_sys_menu` VALUES (30, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dict.list', NULL, '0', NULL, '3', '字典列表', '5', 'dict', '[0],[system],[dict],', '1', NULL, '/dict/list');
INSERT INTO `t_sys_menu` VALUES (31, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dict.detail', NULL, '0', NULL, '3', '字典详情', '6', 'dict', '[0],[system],[dict],', '1', NULL, '/dict/detail');
INSERT INTO `t_sys_menu` VALUES (32, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'dept.add', NULL, '0', NULL, '3', '添加部门', '1', 'dept', '[0],[system],[dept],', '1', NULL, '/dept/add');
INSERT INTO `t_sys_menu` VALUES (33, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'cfg', NULL, '1', NULL, '2', '参数管理', '10', 'system', '[0],[system],', '1', NULL, '/cfg');
INSERT INTO `t_sys_menu` VALUES (34, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'cfg.add', NULL, '0', NULL, '3', '添加系统参数', '1', 'cfg', '[0],[system],[cfg],', '1', NULL, '/cfg/add');
INSERT INTO `t_sys_menu` VALUES (35, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'cfg.edit', NULL, '0', NULL, '3', '修改系统参数', '2', 'cfg', '[0],[system],[cfg],', '1', NULL, '/cfg/update');
INSERT INTO `t_sys_menu` VALUES (36, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'cfg.delete', NULL, '0', NULL, '3', '删除系统参数', '3', 'cfg', '[0],[system],[cfg],', '1', NULL, '/cfg/delete');
INSERT INTO `t_sys_menu` VALUES (37, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'task', NULL, '1', NULL, '2', '任务管理', '11', 'system', '[0],[system],', '1', NULL, '/task');
INSERT INTO `t_sys_menu` VALUES (38, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'task.add', NULL, '0', NULL, '3', '添加任务', '1', 'task', '[0],[system],[task],', '1', NULL, '/task/add');
INSERT INTO `t_sys_menu` VALUES (39, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'task.edit', NULL, '0', NULL, '3', '修改任务', '2', 'task', '[0],[system],[task],', '1', NULL, '/task/update');
INSERT INTO `t_sys_menu` VALUES (40, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'task.delete', NULL, '0', NULL, '3', '删除任务', '3', 'task', '[0],[system],[task],', '1', NULL, '/task/delete');
INSERT INTO `t_sys_menu` VALUES (41, 1, '2024-03-11 22:29:54', 1, '2024-03-11 22:29:54', 'channel', NULL, '1', NULL, '2', '栏目管理', '1', 'cms', '[0],[cms],', '1', NULL, '/channel');
INSERT INTO `t_sys_menu` VALUES (42, 1, '2024-03-11 22:30:17', 1, '2024-03-11 22:30:17', 'article', NULL, '1', NULL, '2', '文章管理', '2', 'cms', '[0],[cms],', '1', NULL, '/article');
INSERT INTO `t_sys_menu` VALUES (43, 1, '2024-03-11 22:30:52', 1, '2024-03-11 22:30:52', 'banner', NULL, '1', NULL, '2', 'banner管理', '3', 'cms', '[0],[cms],', '1', NULL, '/banner');
INSERT INTO `t_sys_menu` VALUES (44, 1, '2024-03-18 19:45:37', 1, '2024-03-18 19:45:37', 'contacts', NULL, '1', NULL, '2', '邀约管理', '4', 'cms', '[0],[cms],', '1', NULL, '/contacts');
INSERT INTO `t_sys_menu` VALUES (45, 1, '2024-03-19 10:25:05', 1, '2024-03-19 10:25:05', 'file', NULL, '1', NULL, '2', '文件管理', '5', 'cms', '[0],[cms],', '1', NULL, '/fileMgr');
INSERT INTO `t_sys_menu` VALUES (46, 1, '2024-03-11 22:30:17', 1, '2024-03-11 22:30:17', 'article.edit', NULL, '1', NULL, '3', '编辑文章', '1', 'article', '[0],[cms],[article]', '1', NULL, '/article/edit');
INSERT INTO `t_sys_menu` VALUES (47, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'task.log', NULL, '1', NULL, '3', '任务日志', '4', 'task', '[0],[system],[task],', '1', NULL, '/taskLog');
INSERT INTO `t_sys_menu` VALUES (48, 1, '2024-07-31 22:04:30', 1, '2024-06-02 10:25:31', 'log', NULL, '1', NULL, '2', '业务日志', '6', 'operationMgr', '[0],[operationMgr],', '1', NULL, '/log');
INSERT INTO `t_sys_menu` VALUES (49, 1, '2024-07-31 22:04:30', 1, '2024-06-02 10:25:36', 'login.log', NULL, '1', NULL, '2', '登录日志', '6', 'operationMgr', '[0],[operationMgr],', '1', NULL, '/loginLog');
INSERT INTO `t_sys_menu` VALUES (50, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'log.clear', NULL, '0', NULL, '3', '清空日志', '3', 'log', '[0],[system],[log],', '1', NULL, '/log/delLog');
INSERT INTO `t_sys_menu` VALUES (51, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'log.detail', NULL, '0', NULL, '3', '日志详情', '3', 'log', '[0],[system],[log],', '1', NULL, '/log/detail');
INSERT INTO `t_sys_menu` VALUES (52, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'login.log.clear', NULL, '0', NULL, '3', '清空登录日志', '1', 'loginLog', '[0],[system],[loginLog],', '1', NULL, '/loginLog/delLoginLog');
INSERT INTO `t_sys_menu` VALUES (53, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'login.log.list', NULL, '0', NULL, '3', '登录日志列表', '2', 'loginLog', '[0],[system],[loginLog],', '1', NULL, '/loginLog/list');
INSERT INTO `t_sys_menu` VALUES (54, 1, '2024-06-02 10:10:20', 1, '2024-06-02 10:10:20', 'druid', NULL, '1', NULL, '2', '数据库管理', '1', 'operationMgr', '[0],[operationMgr],', '1', NULL, '/druid');
INSERT INTO `t_sys_menu` VALUES (55, 1, '2024-06-02 10:10:20', 1, '2024-06-02 10:10:20', 'swagger', NULL, '1', NULL, '2', '接口文档', '2', 'operationMgr', '[0],[operationMgr],', '1', NULL, '/swagger');
INSERT INTO `t_sys_menu` VALUES (56, 1, '2024-06-10 21:26:52', 1, '2024-06-10 21:26:52', 'messageMgr', NULL, '1', NULL, '1', '消息管理', '5', '0', '[0],', '1', NULL, '/message');
INSERT INTO `t_sys_menu` VALUES (57, 1, '2024-06-10 21:27:34', 1, '2024-06-10 21:27:34', 'msg', NULL, '1', NULL, '2', '历史消息', '1', 'messageMgr', '[0],[messageMgr],', '1', NULL, '/history');
INSERT INTO `t_sys_menu` VALUES (58, 1, '2024-06-10 21:27:56', 1, '2024-06-10 21:27:56', 'msg.tpl', NULL, '1', NULL, '2', '消息模板', '2', 'messageMgr', '[0],[messageMgr],', '1', NULL, '/template');
INSERT INTO `t_sys_menu` VALUES (59, 1, '2024-06-10 21:28:21', 1, '2024-06-10 21:28:21', 'msg.sender', NULL, '1', NULL, '2', '消息发送者', '3', 'messageMgr', '[0],[messageMgr],', '1', NULL, '/sender');
INSERT INTO `t_sys_menu` VALUES (60, 1, '2024-06-10 21:28:21', 1, '2024-06-10 21:28:21', 'msg.clear', NULL, '1', NULL, '2', '清空历史消息', '3', 'messageMgr', '[0],[messageMgr],', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (61, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'msg.tpl.edit', NULL, '0', NULL, '3', '编辑消息模板', '1', 'msg.tpl', '[0],[messageMgr],[msg.tpl]', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (62, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'msg.tpl.delete', NULL, '0', NULL, '3', '删除消息模板', '2', 'msg.tpl', '[0],[messageMgr],[msg.tpl]', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (63, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'msg.sender.edit', NULL, '0', NULL, '3', '编辑消息发送器', '1', 'msg.sender', '[0],[messageMgr],[msg.sender]', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (64, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'msg.sender.delete', NULL, '0', NULL, '3', '删除消息发送器', '2', 'msg.sender', '[0],[messageMgr],[msg.sender]', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (65, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'file.upload', NULL, '0', NULL, '3', '上传文件', '1', 'file', '[0],[cms],[file],', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (66, 1, '2024-07-31 21:51:33', 1, '2024-07-31 21:51:33', 'banner.edit', NULL, '0', NULL, '3', '编辑banner', '1', 'banner', '[0],[cms],[banner],', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (67, 1, '2024-07-31 21:51:33', 1, '2024-07-31 21:51:33', 'banner.delete', NULL, '0', NULL, '3', '删除banner', '2', 'banner', '[0],[cms],[banner],', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (68, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'channel.edit', NULL, '0', NULL, '3', '编辑栏目', '1', 'channel', '[0],[cms],[channel],', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (69, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'channel.delete', NULL, '0', NULL, '3', '删除栏目', '2', 'channel', '[0],[cms],[channel],', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (70, 1, '2024-07-31 22:04:30', 1, '2024-07-31 22:04:30', 'article.delete', NULL, '0', NULL, '3', '删除文章', '2', 'article', '[0],[cms],[article]', '1', NULL, NULL);
INSERT INTO `t_sys_menu` VALUES (71, 1, '2024-10-14 16:49:20', NULL, NULL, 'businessMgr', '', '1', '', '1', '业务管理', '1', '0', '[0],', '1', '', '/business');
INSERT INTO `t_sys_menu` VALUES (72, 1, '2024-10-14 16:49:20', NULL, NULL, 'shop', '', '1', '', '2', '商铺管理', '2', 'businessMgr', '[0],[businessMgr],', '1', '', '/business/shop');
INSERT INTO `t_sys_menu` VALUES (73, 1, '2024-10-14 16:49:20', NULL, NULL, 'shop.add', '', '1', '', '2', '添加商铺', '1', 'businessMgr', '[0],[businessMgr],', '1', '', '/business/shop/add');
INSERT INTO `t_sys_menu` VALUES (74, 1, '2024-10-14 16:49:20', NULL, NULL, 'food', '', '1', '', '2', '食品管理', '3', 'businessMgr', '[0],[businessMgr],', '1', '', '/business/food');
INSERT INTO `t_sys_menu` VALUES (75, 1, '2024-10-14 16:49:20', NULL, NULL, 'order', '', '1', '', '2', '订单管理', '4', 'businessMgr', '[0],[businessMgr],', '1', '', '/business/order');
INSERT INTO `t_sys_menu` VALUES (76, 1, '2024-10-14 16:49:20', NULL, NULL, 'food.add', '', '1', '', '2', '添加食品', '6', 'businessMgr', '[0],[businessMgr],', '1', '', '/business/food/add');
INSERT INTO `t_sys_menu` VALUES (77, 1, '2024-10-14 16:49:20', NULL, NULL, 'shop.edit', '', '0', '', '3', '修改商铺', '1', 'shop', '[0],[businessMgr],[shop],', '1', '', '/business/shop/edit');
INSERT INTO `t_sys_menu` VALUES (78, 1, '2024-10-14 16:49:20', NULL, NULL, 'shop.delete', '', '0', '', '3', '删除商铺', '5', 'shop', '[0],[businessMgr],[shop],', '1', '', '/business/shop/delete');
INSERT INTO `t_sys_menu` VALUES (79, 1, '2024-10-14 16:49:20', NULL, NULL, 'food.edit', '', '0', '', '3', '修改食品', '1', 'food', '[0],[businessMgr],[food],', '1', '', '/business/food/edit');
INSERT INTO `t_sys_menu` VALUES (80, 1, '2024-10-14 16:49:20', NULL, NULL, 'food.delete', '', '0', '', '3', '删除食品', '2', 'food', '[0],[businessMgr],[food],', '1', '', '/business/food/delete');
INSERT INTO `t_sys_menu` VALUES (81, 1, '2024-10-14 16:49:20', NULL, NULL, 'food.audit', '', '0', '', '3', '审核食品', '3', 'food', '[0],[businessMgr],[food],', '1', '', '/business/food/audit');
INSERT INTO `t_sys_menu` VALUES (82, 1, '2024-10-14 16:49:20', NULL, NULL, 'shop.audit', '', '0', '', '3', '审核商铺', '3', 'shop', '[0],[businessMgr],[shop],', '1', '', '/business/shop/audit');
INSERT INTO `t_sys_menu` VALUES (83, 1, '2024-10-14 16:49:20', NULL, NULL, 'sdetail', '', '1', '', '2', '我的商铺', '2', 'businessMgr', '[0],[businessMgr],', '1', '', '/business/sdetail');
INSERT INTO `t_sys_menu` VALUES (84, 1, '2024-10-14 16:49:20', NULL, NULL, 'orderdetail', '', '1', '', '2', '订单详情', '2', 'orderdetail', '[0],[businessMgr],', '1', '', '/business/orderdetail');
...
-- ----------------------------
INSERT INTO `t_sys_notice` VALUES (1, 1, '2024-01-11 08:53:20', 1, '2024-01-08 23:30:58', '欢迎使用犀焰澄泓团队后台管理系统', '世界', 10);
...
CREATE TABLE `t_sys_operation_log`  (
  ...
  `logname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `logtype` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '详细信息',
...
-- ----------------------------
INSERT INTO `t_sys_operation_log` VALUES (1, 'cn.xiyanchenghong.waimai.api.controller.cms.ArticleMgrController', '2024-05-10 13:22:49', '添加参数', '业务日志', '参数名称=system.app.name', 'upload', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (2, 'cn.xiyanchenghong.waimai.api.controller.cms.ArticleMgrController', '2024-06-10 13:31:09', '修改参数', '业务日志', '参数名称=system.app.name', 'upload', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (3, 'cn.xiyanchenghong.waimai.api.controller.cms.ArticleMgrController', '2024-07-10 13:22:49', '编辑文章', '业务日志', '参数名称=system.app.name', 'upload', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (4, 'cn.xiyanchenghong.waimai.api.controller.cms.ArticleMgrController', '2024-08-10 13:31:09', '编辑栏目', '业务日志', '参数名称=system.app.name', 'upload', '成功', 1);
...
CREATE TABLE `t_sys_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 160 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单角色关系' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_sys_role` VALUES (3, 1, '2024-05-14 17:04:28', NULL, NULL, NULL, '商铺人员', 3, 0, 'shop', NULL);
...
CREATE TABLE `t_sys_task`  (
  ...
  `job_class` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '执行类',
  `job_group` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '任务组名',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '任务名',
...
-- ----------------------------
INSERT INTO `t_sys_task` VALUES (1, 1, '2024-12-28 09:54:00', -1, '2024-03-27 11:47:11', 0, '0 0/30 * * * ?', '{\n\"appname\": \"flash-waimai\",\n\"version\":1\n}\n            \n            \n            \n            \n            \n            \n            \n            \n            \n            \n            \n            ', 0, '2024-03-27 11:47:00', '执行成功', 'cn.xiyanchenghong.waimai.service.task.job.HelloJob', 'default', '测试任务', '测试任务,每30分钟执行一次');
...
CREATE TABLE `t_sys_task_log`  (
  ...
  `job_exception` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '抛出异常',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '任务名',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_sys_user`  (
  ...
  `version` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '账号' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_sys_user` VALUES (1, NULL, '2024-01-29 08:49:53', 1, '2024-03-20 23:45:24', 'admin', NULL, '2024-05-05 00:00:00', 27, 'eniluzt@qq.com', '管理员', 'b5a51391f271f062867e5984e2fcffee', '15021222222', '1', '8pgby', 2, 1, 25);
INSERT INTO `t_sys_user` VALUES (2, NULL, '2024-09-13 17:21:02', 1, '2024-01-09 23:05:51', 'developer', NULL, '2024-12-31 00:00:00', 25, 'eniluzt@qq.com', '网站管理员', 'fac36d5616fe9ebd460691264b28ee27', '15022222222', '2,', 'vscp9', 1, 1, NULL);
...
CREATE TABLE `t_test_boy`  (
  ...
  `birthday` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '生日',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '男孩' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_test_girl`  (
  ...
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '姓名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '女孩' ROW_FORMAT = Dynamic;
