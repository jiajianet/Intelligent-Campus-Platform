...
import cn.xiyanchenghong.waimai.bean.entity.front.sub.Rating;
import cn.xiyanchenghong.waimai.bean.entity.front.sub.Score;
import cn.xiyanchenghong.waimai.bean.entity.front.sub.Tag;
