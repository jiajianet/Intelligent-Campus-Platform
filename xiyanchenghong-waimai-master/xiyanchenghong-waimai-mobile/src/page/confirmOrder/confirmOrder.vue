<template>
    <div class="confirmOrderContainer">
        <section v-if="!showLoading">
            <head-top head-title="提交订单" goBack="true" signin-up='confirmOrder'></head-top>
            ...
            <section class="delivery_model container_style">
                <p class="deliver_text">配送时间</p>
                <section class="deliver_time">
                    <p>尽快配送 | 预计 {{checkoutData.delivery_reach_time}}</p>
                    <p v-if="checkoutData.cart.is_deliver_by_fengniao">智慧专送</p>
                </section>
            </section>
