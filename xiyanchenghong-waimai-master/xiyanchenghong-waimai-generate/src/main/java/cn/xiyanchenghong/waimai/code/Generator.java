package cn.xiyanchenghong.waimai.code;
...
public class Generator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String module = "test";
        String basePackageName = "cn.xiyanchenghong.waimai";
        ...
        options.addOption("p", "package", true, "base package name,default:cn.xiyanchenghong.waimai");
